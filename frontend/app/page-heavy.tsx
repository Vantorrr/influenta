...
export default function HomePage() {
  ...
  // Отключил mouse tracking для производительности
  ...
  // Floating particles - уменьшил количество
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-gradient-to-br from-telegram-bg via-telegram-bgSecondary to-telegram-bg overflow-hidden">
      ...
      <div className="fixed inset-0 z-0">
        {/* Gradient orbs - статичные для производительности */}
        <div className="absolute top-20 left-20 w-96 h-96 bg-telegram-primary/10 rounded-full blur-3xl" />
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-telegram-accent/10 rounded-full blur-3xl" />
